# Sexy AJAX Nav
## IMPORTANT!! - Before running, rename binBak folder to bin else the app will not run correctly.
...
<ul>
  ...
  <li>
    Open your web browser and navigate to <code>http://localhost:3001/</code>
    to view API Server.
  </li>
</ul>
...
<ul>
  <li>
    I decided to take things a step further with this by creating an API server. This runs alongside this application at runtime. All application data is served via this API server.
  </li>
  <li>
  Overly verbose comments detailing what I did and why I did it available in <code>./client/public/js/hugeNavigation.js</code>
  </li>
  <li>
  Resize the window to see mobile/tablet/desktop views of this application.
  </li>
</ul>
